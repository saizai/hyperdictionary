...
* comments and tagging w/ AJAX, subscription, & email notification
* intelligent profile role levels
...
* You need to get your own API keys. Some of mine will work, but only for localhost. Look in config/initializers.
