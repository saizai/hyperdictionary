...
* full scale users & profiles
  ...
  * comments and tagging w/ AJAX, subscriptions, RSS, & email notification
...
* well factored, fully documented, efficient, bug-free, easy to understand, resource-oriented code
