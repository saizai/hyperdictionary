...
#    rename_table :profile_versions, :page_versions
    ...
    CommentVersion.update_all('commentable_type = "Page"', 'commentable_type = "Profile"')
    ...
    Slug.destroy_all('authorizable_type = "Profile"')
  end
  ...
  def self.down
    ...
    CommentVersion.update_all('commentable_type = "Profile"', 'commentable_type = "Page"')
